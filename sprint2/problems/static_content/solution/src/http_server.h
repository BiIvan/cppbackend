...
namespace http_server {
  ...
  template <typename RequestHandler>
  void ServeHttp( net::io_context& ioc, const tcp::endpoint& endpoint, RequestHandler& request_handler) {
    std::make_shared<Listener<RequestHandler>>( ioc, endpoint, request_handler )->Run();
  }
